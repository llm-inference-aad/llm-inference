...
python src/llm_mutation.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/models/network_xXxobGIvqcn0xeZVI0lVECJF2KD.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/models/network_xXxYSuMQMEdyxRPciT0LNibKJAQ.py 0/xXxYSuMQMEdyxRPciT0LNibKJAQ_model.txt --top_p 0.1 --temperature 0.16 --apply_quality_control 'False' --inference_submission False --gene_id xXxYSuMQMEdyxRPciT0LNibKJAQ
