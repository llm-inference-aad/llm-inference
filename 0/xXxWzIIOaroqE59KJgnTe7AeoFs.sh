...
python src/llm_mutation.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/network.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/models/network_xXxWzIIOaroqE59KJgnTe7AeoFs.py 0/xXxWzIIOaroqE59KJgnTe7AeoFs_model.txt --top_p 0.1 --temperature 0.33 --apply_quality_control 'False' --inference_submission False --gene_id xXxWzIIOaroqE59KJgnTe7AeoFs
