...
python src/llm_mutation.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/network.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/models/network_xXxqWuEHMcTGN6pcDDFAjgYqHgL.py 0/xXxqWuEHMcTGN6pcDDFAjgYqHgL_model.txt --top_p 0.1 --temperature 0.35 --apply_quality_control 'False' --inference_submission False --gene_id xXxqWuEHMcTGN6pcDDFAjgYqHgL
