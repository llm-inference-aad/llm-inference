...
#SBATCH -n 12
#SBATCH -N 1
#SBATCH --output=/home/hice1/rkansal8/scratch/llm-inference/slurm-results/eval-%j.out
#SBATCH --error=/home/hice1/rkansal8/scratch/llm-inference/slurm-results/eval-%j.err
...
# Run Python script
python ./sota/ExquisiteNetV2/train.py -bs 216 -network "models.network_xXxfIbgrIjC8BaopPELrI0YxZ4r" -data ./cifar10 -end_lr 0.001 -seed 21 -val_r 0.2 -amp
