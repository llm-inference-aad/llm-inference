...
# Run Python script
python ./sota/ExquisiteNetV2/train.py -bs 216 -network "models.network_xXxEa6xq956TxfW7eAsa45PJ13F" -data ./cifar10 -end_lr 0.001 -seed 21 -val_r 0.2 -amp -epoch 24
EXIT_CODE=$?
