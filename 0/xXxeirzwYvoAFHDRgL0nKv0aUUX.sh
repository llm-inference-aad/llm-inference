...
python src/llm_mutation.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/models/network_xXxdBSLuQBEAhEaB6yz6IrhHsk2.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/models/network_xXxeirzwYvoAFHDRgL0nKv0aUUX.py 0/xXxeirzwYvoAFHDRgL0nKv0aUUX_model.txt --top_p 0.1 --temperature 0.2 --apply_quality_control 'False' --inference_submission False --gene_id xXxeirzwYvoAFHDRgL0nKv0aUUX
