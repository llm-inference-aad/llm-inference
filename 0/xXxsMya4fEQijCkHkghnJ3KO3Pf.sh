...
python src/llm_mutation.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/network.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/models/network_xXxsMya4fEQijCkHkghnJ3KO3Pf.py 0/xXxsMya4fEQijCkHkghnJ3KO3Pf_model.txt --top_p 0.1 --temperature 0.21 --apply_quality_control 'False' --inference_submission False --gene_id xXxsMya4fEQijCkHkghnJ3KO3Pf
