...
python src/llm_mutation.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/network.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/models/network_xXxLts2YqZSwyvYCufKL8331H2O.py 0/xXxLts2YqZSwyvYCufKL8331H2O_model.txt --top_p 0.1 --temperature 0.32 --apply_quality_control 'False' --inference_submission False --gene_id xXxLts2YqZSwyvYCufKL8331H2O
