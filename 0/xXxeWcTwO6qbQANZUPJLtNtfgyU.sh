...
python src/llm_mutation.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/network.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/models/network_xXxeWcTwO6qbQANZUPJLtNtfgyU.py 0/xXxeWcTwO6qbQANZUPJLtNtfgyU_model.txt --top_p 0.1 --temperature 0.12 --apply_quality_control 'False' --inference_submission False --gene_id xXxeWcTwO6qbQANZUPJLtNtfgyU
