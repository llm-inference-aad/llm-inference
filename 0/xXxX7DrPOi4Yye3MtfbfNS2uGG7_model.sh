...
# Run Python script
python ./sota/ExquisiteNetV2/train.py -bs 216 -network "models.network_xXxX7DrPOi4Yye3MtfbfNS2uGG7" -data ./cifar10 -end_lr 0.001 -seed 21 -val_r 0.2 -amp -epoch 24
EXIT_CODE=$?
