...
python src/llm_mutation.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/network.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/models/network_xXxyQahC2u0owQlOVzURCICVCGh.py 0/xXxyQahC2u0owQlOVzURCICVCGh_model.txt --top_p 0.1 --temperature 0.3 --apply_quality_control 'False' --inference_submission False --gene_id xXxyQahC2u0owQlOVzURCICVCGh
