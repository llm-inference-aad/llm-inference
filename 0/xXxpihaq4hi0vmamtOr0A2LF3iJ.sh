...
python src/llm_mutation.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/models/network_xXxh2lc35OsmJ0MEuywsIzjNg1a.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/models/network_xXxpihaq4hi0vmamtOr0A2LF3iJ.py 0/xXxpihaq4hi0vmamtOr0A2LF3iJ_model.txt --top_p 0.1 --temperature 0.08 --apply_quality_control 'False' --inference_submission False --gene_id xXxpihaq4hi0vmamtOr0A2LF3iJ
