...
python src/llm_mutation.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/models/network_xXxLts2YqZSwyvYCufKL8331H2O.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/models/network_xXxyEjsehrEHnlJOAPS7w85OfNa.py 0/xXxyEjsehrEHnlJOAPS7w85OfNa_model.txt --top_p 0.1 --temperature 0.31 --apply_quality_control 'False' --inference_submission False --gene_id xXxyEjsehrEHnlJOAPS7w85OfNa
