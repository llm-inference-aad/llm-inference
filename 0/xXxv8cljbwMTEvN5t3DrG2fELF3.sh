...
python src/llm_mutation.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/network.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/models/network_xXxv8cljbwMTEvN5t3DrG2fELF3.py 0/xXxv8cljbwMTEvN5t3DrG2fELF3_model.txt --top_p 0.1 --temperature 0.18 --apply_quality_control 'False' --inference_submission False --gene_id xXxv8cljbwMTEvN5t3DrG2fELF3
