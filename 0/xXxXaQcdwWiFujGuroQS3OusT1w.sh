...
python src/llm_mutation.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/network.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/models/network_xXxXaQcdwWiFujGuroQS3OusT1w.py 0/xXxXaQcdwWiFujGuroQS3OusT1w_model.txt --top_p 0.1 --temperature 0.23 --apply_quality_control 'False' --inference_submission False --gene_id xXxXaQcdwWiFujGuroQS3OusT1w
