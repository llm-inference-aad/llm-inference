...
python src/llm_mutation.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/network.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/models/network_xXx8JoCoU0EAstSdu9qVKOxMjvM.py 0/xXx8JoCoU0EAstSdu9qVKOxMjvM_model.txt --top_p 0.1 --temperature 0.09 --apply_quality_control 'False' --inference_submission False --gene_id xXx8JoCoU0EAstSdu9qVKOxMjvM
