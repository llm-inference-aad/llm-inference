...
# Run Python script
python ./sota/ExquisiteNetV2/train.py -bs 216 -network "models.network_xXxQR6lxThSeO6cTz8L0Qa21hjv" -data ./cifar10 -end_lr 0.001 -seed 21 -val_r 0.2 -amp -epoch 24
EXIT_CODE=$?
