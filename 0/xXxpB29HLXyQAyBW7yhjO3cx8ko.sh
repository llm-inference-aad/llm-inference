...
python src/llm_mutation.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/network.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/models/network_xXxpB29HLXyQAyBW7yhjO3cx8ko.py 0/xXxpB29HLXyQAyBW7yhjO3cx8ko_model.txt --top_p 0.1 --temperature 0.08 --apply_quality_control 'False' --inference_submission False --gene_id xXxpB29HLXyQAyBW7yhjO3cx8ko
