...
python src/llm_mutation.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/network.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/models/network_xXxa6zFS0OfmLO87LEpacuBmM0g.py 0/xXxa6zFS0OfmLO87LEpacuBmM0g_model.txt --top_p 0.1 --temperature 0.12 --apply_quality_control 'False' --inference_submission False --gene_id xXxa6zFS0OfmLO87LEpacuBmM0g
