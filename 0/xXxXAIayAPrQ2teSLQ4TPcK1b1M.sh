...
python src/llm_mutation.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/network.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/models/network_xXxXAIayAPrQ2teSLQ4TPcK1b1M.py 0/xXxXAIayAPrQ2teSLQ4TPcK1b1M_model.txt --top_p 0.1 --temperature 0.22 --apply_quality_control 'False' --inference_submission False --gene_id xXxXAIayAPrQ2teSLQ4TPcK1b1M
