...
python src/llm_mutation.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/network.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/models/network_xXxlEouX7XVx1a5rgR6WTInVsQm.py 0/xXxlEouX7XVx1a5rgR6WTInVsQm_model.txt --top_p 0.1 --temperature 0.37 --apply_quality_control 'False' --inference_submission False --gene_id xXxlEouX7XVx1a5rgR6WTInVsQm
