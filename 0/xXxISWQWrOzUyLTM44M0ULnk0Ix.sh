...
python src/llm_mutation.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/network.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/models/network_xXxISWQWrOzUyLTM44M0ULnk0Ix.py 0/xXxISWQWrOzUyLTM44M0ULnk0Ix_model.txt --top_p 0.1 --temperature 0.34 --apply_quality_control 'False' --inference_submission False --gene_id xXxISWQWrOzUyLTM44M0ULnk0Ix
