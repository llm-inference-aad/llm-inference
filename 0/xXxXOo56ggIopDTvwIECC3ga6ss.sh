...
python src/llm_mutation.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/network.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/models/network_xXxXOo56ggIopDTvwIECC3ga6ss.py 0/xXxXOo56ggIopDTvwIECC3ga6ss_model.txt --top_p 0.1 --temperature 0.31 --apply_quality_control 'False' --inference_submission False --gene_id xXxXOo56ggIopDTvwIECC3ga6ss
