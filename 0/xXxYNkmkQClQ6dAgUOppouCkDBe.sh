...
python src/llm_mutation.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/models/network_xXxSGH4LOzZ7yyyIJuD7KutjLUI.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/models/network_xXxYNkmkQClQ6dAgUOppouCkDBe.py 0/xXxYNkmkQClQ6dAgUOppouCkDBe_model.txt --top_p 0.1 --temperature 0.07 --apply_quality_control 'False' --inference_submission False --gene_id xXxYNkmkQClQ6dAgUOppouCkDBe
