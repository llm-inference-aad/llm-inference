...
# Run Python script
python ./sota/ExquisiteNetV2/train.py -bs 216 -network "models.network_xXxVPHP1pz3pF7awdB5SV9y5p3d" -data ./cifar10 -end_lr 0.001 -seed 21 -val_r 0.2 -amp -epoch 24
EXIT_CODE=$?
