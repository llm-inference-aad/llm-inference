...
python src/llm_mutation.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/network.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/models/network_xXxScUXS06PbsaxvaEXHVp2kKyv.py 0/xXxScUXS06PbsaxvaEXHVp2kKyv_model.txt --top_p 0.1 --temperature 0.28 --apply_quality_control 'False' --inference_submission False --gene_id xXxScUXS06PbsaxvaEXHVp2kKyv
