...
python src/llm_mutation.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/network.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/models/network_xXxvpHEG8MqA1vdpUcFJYEEK8Xy.py 0/xXxvpHEG8MqA1vdpUcFJYEEK8Xy_model.txt --top_p 0.1 --temperature 0.08 --apply_quality_control 'False' --inference_submission False --gene_id xXxvpHEG8MqA1vdpUcFJYEEK8Xy
