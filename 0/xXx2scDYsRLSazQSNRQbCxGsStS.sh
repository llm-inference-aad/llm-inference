...
python src/llm_mutation.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/models/network_xXx5FrMCg2ZG26mQeNdmBTWhihW.py /home/hice1/jgil37/scratch/llm-inference/sota/ExquisiteNetV2/models/network_xXx2scDYsRLSazQSNRQbCxGsStS.py 0/xXx2scDYsRLSazQSNRQbCxGsStS_model.txt --top_p 0.1 --temperature 0.13 --apply_quality_control 'False' --inference_submission False --gene_id xXx2scDYsRLSazQSNRQbCxGsStS
