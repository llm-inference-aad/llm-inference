...
class EConvBlock(nn.Module):
    def __init__(self, cin, cout, stride=1, use_se_ln=True):
        super().__init__()
        ...
        self.act = Swish()
        self.attention = SE_LN(cout) if use_se_ln else SA_DynCS(cout) if cout > 1 else nn.Identity()
