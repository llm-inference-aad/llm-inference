...
class SE(nn.Module):
    def __init__(self, cin, ratio):
        ...
        reduced_dim = int(cin // ratio)
        self.fc1 = nn.Linear(cin, reduced_dim)
        self.ln = nn.LayerNorm(reduced_dim)
        self.act1 = nn.ReLU()
        self.fc2 = nn.Linear(reduced_dim, cin)
...
class SE(nn.Module):
    def __init__(self, cin, ratio):
        ...
        self.bn = nn.BatchNorm1d(int(cin//ratio))
        self.act1 = nn.SiLU()
