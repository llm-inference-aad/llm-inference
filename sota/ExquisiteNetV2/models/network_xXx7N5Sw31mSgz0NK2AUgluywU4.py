...
class ExquisiteNetV2(nn.Module):
    def __init__(self, class_num, img_channels):
        ...
        self.blocks = nn.ModuleList([DFSEBV2(12, 3, True), EVE(12, 48), DFSEBV2(48, 3, True),
                                     ME(48, 96), DFSEBV2(96, 3, True), ME(96, 192), DFSEBV2(192, 3, True),
                                     ME(192, 384), DFSEBV2(384, 3, True)])
        self.DW = DW(384, 3)
        self.gavg = nn.AdaptiveAvgPool2d((1,1))
