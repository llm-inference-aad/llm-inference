...
class CIFAR10Classifier(nn.Module):
    def __init__(self):
        super().__init__()
        self.stage1 = FCT(cin=3, cout=64, dw_kernel_size=3, dw_stride=1, dw_padding=1, 
                           pool_ks=2, use_bn=True, activation='swish')
        self.stage2 = FCT(cin=64, cout=128, dw_kernel_size=3, dw_stride=2, dw_padding=1, 
                          pool_ks=2, use_bn=True, activation='swish')
        self.stage3 = FCT(cin=128, cout=256, dw_kernel_size=3, dw_stride=2, dw_padding=1, 
                          pool_ks=2, use_bn=True, activation='swish')
