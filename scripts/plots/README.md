...
- `run_summary.png` - Comprehensive 4-panel evolution run summary (accuracy, time, stats)
- `llm_metrics.png` - Comprehensive 4-panel LLM inference metrics (latency, batching, etc.)
...
- `pareto_analysis.png` - Pareto front for multi-objective optimization
