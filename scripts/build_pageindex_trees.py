...
def build_trees(corpus_dir: Path, output_dir: Path, model: str, force: bool = False) -> None:
    ...
    opt = ConfigLoader().load({
        ...
        "if_add_node_id": "yes",
        # Sized for the local 8K-context vLLM server. The TOC-detection
        # batches (page_list_to_group_text) are tuned via
        # PAGEINDEX_GROUP_MAX_TOKENS in src/pageindex/pageindex/page_index.py.
